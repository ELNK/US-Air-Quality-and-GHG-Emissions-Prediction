...
def load_facilities_data():
    return pd.read_csv(f'{RAW_DATA_DIR}/us_greenhouse_gas_emissions_direct_emitter_facilities.csv', low_memory=False)
...
def load_county_mapping():
    return pd.read_csv(f'{RAW_DATA_DIR}/county_mapping.csv')
